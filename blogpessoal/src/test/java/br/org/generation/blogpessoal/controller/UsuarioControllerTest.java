...
@TestMethodOrder(MethodOrderer.OrderAnnotation.class) //definir ordem de execusão do teste
public class UsuarioControllerTest {
	...
	@Test
	@Order(1)
	@DisplayName("Cadastrar Um Usuário") //Apelido
